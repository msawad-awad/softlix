...
const newProjects = [
  ...
  },
  {
    slug: "maskaniun",
    title: "تطبيق مساكني",
    titleEn: "Maskaniun App",
    clientName: "مساكني",
    category: "mobile-app",
    description: "تطبيق سكني للبحث عن العقارات والسكن",
    descriptionEn: "Housing search mobile application",
  ...
  },
  {
    ...
    clientName: "تيسير",
    category: "mobile-app",
    description: "تطبيق تيسير للخدمات والطلبات",
    descriptionEn: "Taysir services request application",
  ...
  },
  {
    ...
    clientName: "جماله",
    category: "mobile-app",
    description: "تطبيق جماله للعناية والجمال",
    descriptionEn: "Jamala beauty and care application",
    technologies: ["Flutter", "Node.js", "Firebase"],
    thumbnailUrl: null,
    order: 17,
  },
  {
    ...
    clientName: "ساعد",
    category: "mobile-app",
    description: "تطبيق ساعد للعمل والتوظيف",
    descriptionEn: "Saeid employment platform",
  ...
  {
    slug: "transfer-app",
    title: "تطبيق ترانسفير",
    titleEn: "Transfer App",
    clientName: "ترانسفير",
    category: "mobile-app",
    description: "تطبيق التحويلات المالية",
    descriptionEn: "Money transfer application",
  ...
  },
  {
    slug: "estalimni-app",
    title: "تطبيق استلمني",
    titleEn: "Estalimni App",
    clientName: "استلمني",
    category: "mobile-app",
    description: "تطبيق استلمني للتوصيل والشحن",
    descriptionEn: "Estalimni delivery application",
    technologies: ["React Native", "Node.js", "Firebase"],
    thumbnailUrl: null,
    order: 20,
  },
  {
    slug: "my-facility",
    title: "منصة ماي فاسيلتي",
    titleEn: "My Facility Platform",
    clientName: "My Facility",
    category: "web-platform",
    description: "منصة سوق تصنيفات سعودية هجينة متقدمة تربط المعلنين الأفراد مع الشركات المتخصصة في بيئة آمنة وموثوقة",
    descriptionEn: "Advanced Saudi hybrid classified marketplace platform connecting individual advertisers with specialized companies in a safe and trusted environment",
    technologies: ["React", "Vite", "Express.js", "PostgreSQL", "Drizzle ORM", "Cloudflare R2", "Capacitor", "Railway", "Tailwind CSS", "WebSocket"],
    thumbnailUrl: null,
    order: 7,
  },
];
